...
UINT32 g_CryptoBase64_enc(const char *encoded, int encodedLength, char *decoded)  
{
    UINT32 l_RetLen = 0U;
    printf("Do base enc operation\n");
    l_RetLen = EVP_EncodeBlock((unsigned char*)decoded, (const unsigned char*)encoded, encodedLength);
    return l_RetLen;
}
