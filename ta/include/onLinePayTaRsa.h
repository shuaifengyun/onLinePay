...
extern int g_CryptoTaHandle_Rsa(CHAR* pInput, UINT32 lenInput, CHAR* pOutput, UINT32 lenOutput,
    UINT32 opMode, UINT32 padding, UINT32 flag);

extern UINT32 g_CryptoTaHandle_PickPublicKey(CHAR* buf);
