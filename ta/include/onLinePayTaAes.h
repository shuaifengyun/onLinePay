...
extern int g_CryptoTaHandle_Aes(CHAR* pInput, UINT32 lenInput, CHAR* pOutput,
        EN_AES_OPERATION_ACTION active, EN_AES_MODE mode);


extern void g_CryptoTaHandle_GetRandomOne(CHAR* buf, UINT32 len);
extern void g_CryptoTaHandle_SaveRandomTwo(CHAR* buf, UINT32 len);
extern void g_CryptoTaHandle_GetRandomThree(CHAR* buf, UINT32 len);
extern void g_CryptoTaHandle_SetAesKey(void);
